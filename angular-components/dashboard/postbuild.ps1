...
xcopy /s ".\dist\dashboard\" "..\..\com.ataxlab.functions.table.retention.dashboard.rcl\wwwroot\angular"  /Y
...
xcopy /s ".\src\assets\app-root.html" "..\..\com.ataxlab.functions.table.retention.dashboard.rcl\wwwroot\angular" /Y
