...
using com.ataxlab.functions.table.retention.dashboard.options;
...
namespace com.ataxlab.functions.table.retention.dashboard
{
    ...
    public class OnBehalfOfMsGraphAuthenticationProvider : IAuthenticationProvider
    {
        ...
        private readonly AzureAd _authSettings;

        public OnBehalfOfMsGraphAuthenticationProvider(
            IDistributedCache distributedCache,
            ILoggerFactory loggerFactory,
            IDataProtectionProvider dataProtectionProvider,
            IOptions<AzureAd> authenticationOptions,
        ...
        public async Task AuthenticateRequestAsync(HttpRequestMessage request)
        {
            ...
            var authContext = new AuthenticationContext(_authSettings.Domain, cache);
